...
function fetchData(data, count){
    ...
    fetch('https://insumostermicos.dimarketing.com.mx/static/db/connection.php',{
        method: "POST",
        body: data
    })
        .then(function(response){
            // Si ocurre un error en la solicitud
            if(response.status !== 200){c
    ...
    return `
            ...
            <div class="control">
                <div id="product__detail" class="product">
                    <div class="thumbnail">
                       <img src="https://insumostermicos.dimarketing.com.mx/static/img/products/regulador/regulador1.png" alt="product">
                    </div>
                <div class="details">
